...
//                        <a href="'.url('countries/destroy' , $row->id).'" class="btn btn-danger">Delete</a>
        ...
        return view('dashboard.orders.index',compact('today_price','today','total_price','number'));
    }
    public function today(Request $request)
    {
        ...
        if ($request->ajax()) {
                // dd('ajax');
                $data = Order::where('status','!=',0)->where('created_at','>=',  Carbon::today())->latest()->get();
...
//                        <a href="'.url('countries/destroy' , $row->id).'" class="btn btn-danger">Delete</a>
        ...
        return view('dashboard.orders.today',compact('today_price','today','total_price','number'));
    }
