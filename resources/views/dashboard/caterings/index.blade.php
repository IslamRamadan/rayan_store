...
@section('page_title')  @lang('site.caterings')  @endsection
        ...
        <div class="row">
            <div class="col-lg-12 margin-tb">
                ...
                <div class="pull-right">
                    ...
                    <a class="btn btn-success mb-2" href="{{route('caterings.create')}}">@lang('site.add_catering')</a>
                </div>
            </div>
        </div>
            ...
            <div class="table-responsive p-0">
                <table class="table align-items-center justify-content-center mb-0 data-table  text-secondary text-xs ">
                    ...
                    <tr>
                        ...
                        <th>@lang('site.add_person_price')</th>
                        <th>@lang('site.setup_time')</th>
                        <th>@lang('site.max_time')</th>
                        <th>@lang('site.ad_hour_price')</th>
                        <th>@lang('site.ad_service_price')</th>
        ...
        $(document).ready(function () {
            ...
            var table = $('.data-table').DataTable({
                ...
                columns: [
                    ...
                    {data: 'persons_no', name: 'persons_no'},
                    {data: 'price', name: 'price'},
                    {data: 'add_person_price', name: 'add_person_price'},
                    {data: 'setup_time', name: 'setup_time'},
                    {data: 'max_time', name: 'max_time'},
                    {data: 'ad_hour_price', name: 'ad_hour_price'},
                    {data: 'ad_service_price', name: 'ad_service_price'},
