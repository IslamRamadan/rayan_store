...
@section('page_title')  @lang('site.paid_catering_orders')  @endsection
...
@section('content')
    <div class="container">
        ...
        <div class="card-header pb-0 text-center">
            <h3>
                @lang('site.paid_catering_orders')
            </h3>
        </div>
        <div class="row mt-2">
            ...
            <div class="col-xl-3 col-sm-6  mb-4">
                <a href="{{route('catering_orders.today')}}">
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        var table = $('.data-table').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('catering_orders.index') }}",
            columns: [
