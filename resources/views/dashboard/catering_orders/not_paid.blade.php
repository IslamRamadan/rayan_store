    ...
    <div class="container">
        ...
        <div class="row mt-2 justify-content-center">
            <div class="col-xl-3 col-sm-6  mb-4">
                <a href="{{route('catering_noorders')}}">
                        ...
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers dir-rtl">
                                    <p class="text-sm mb-0 text-capitalize font-weight-bold">@lang('site.num_not_paid_orders')</p>
                                    <h5 class="font-weight-bolder mb-0">
                                        {{App\CateringOrder::where('status',0)->count()}}
                                    </h5>
                                </div>
                            </div>
                ...
                <div class="card">
                    <div class="card-body p-3">
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers dir-rtl">
                                    <p class="text-sm mb-0 text-capitalize font-weight-bold">@lang('site.total_not_orders')</p>
                                    <h5 class="font-weight-bolder mb-0">
                                        {{App\CateringOrder::where('status',0)->sum('total_price')}} @lang('site.kwd')
                                    </h5>
                                </div>
                            </div>
                            <div class="col-4 text-end">
        ...
        <div class="card-body px-0 pt-0 pb-2">
            ...
            <th width="10%">@lang('site.date_of_order')</th>
