...
Route::group(
    ...
    function () { //...
        ...
        Route::group(['middleware' => ['auth']], function () {
            ...
            Route::get('profile/my-halls', 'front\ProfileController@halls')->name('my.halls');
            Route::get('profile/my-caterings', 'front\ProfileController@caterings')->name('my.caterings');
        ...
        Route::post('/checkDate', 'front\orderController@checkDate')->name('check.date');
        ...
        Route::group(['middleware' => ['adminAuth',  'role:admin']], function () {
            ...
            Route::get('catering_items/view/{order_id}', 'Backend\CateringOrderController@items')->name('catering_order.items.view');
            Route::get('order/receive/{order_id}', 'Backend\OrderController@receive')->name('orders.received');
            Route::get('catering_order/receive/{order_id}', 'Backend\CateringOrderController@receive')->name('catering_orders.received');
